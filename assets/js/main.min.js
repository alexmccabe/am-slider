...
!function(n){"use strict";function t(t,i){if(i.directionControls===!0&&0===n(".am-direction-controls").length){var e='<ul class="am-direction-controls"><li class="am-prev"><a href="#">'+i.directionContolsText.prev+'</a></li><li class="am-next"><a href="#">'+i.directionContolsText.next+"</a></li></ul>";n(t).append(e)}}function i(t,i){if(".am-nav-controls"===i.navControlsClass&&0===n(".am-nav-controls").length){for(var e='<ul class="am-nav-controls">',a=n(i.slideContainer).find(i.slideElement).length,s=1;a+1>s;s++)e+='<li class="am-tab"><a href="#">'+s+"</a></li>";e+="</ul>",n(t).append(e)}else n(i.navControlsClass).children().addClass("am-tab")}function e(n){if("undefined"==typeof window.Modernizr){var t=document.body||document.documentElement,i=t.style,e="transition";if("string"==typeof i[e])return!0;e=e.charAt(0).toUpperCase()+e.substr(1);for(var a=0;a<n.length;a++)if("string"==typeof i[n[a]+e])return!0;return!1}return Modernizr.csstransitions?!0:void 0}n.slider=function(a,s){this.options={},this.el=n(a),this.init=function(a,s){var o=this;o.options=n.extend({},n.slider.defaultOptions,s),s=o.options,o.slideContainer=o.el.children(s.slideContainer),o.slides=n(o.slideContainer).find(s.slideElement),o.numSlides=o.slides.length,o.isAnimating=!1,o.current=0,o.setInterval=null,o.transitionSupport=!1,o.domPrefixes="webkit Webkit Moz O ms Khtml".split(" "),e(o.domPrefixes)&&(o.transitionSupport=!0),console.log(o.transitionSupport),s.directionControls&&t(a,s),s.navControls&&i(a,s),o.slides.eq(o.current).addClass("am-current"),n(".am-tab").eq(o.current).addClass("am-tab-current"),this.initEvents()},this.initEvents=function(){var t=this;t.slides.css("transition-duration",t.options.animDuration/1e3+"s"),t.options.autoPlay&&t.play(),t.options.pauseOnHover&&t.options.autoPlay&&t.el.hover(function(){t.pause()},function(){t.play()}),n(".am-prev").click(function(n){n.preventDefault(),t.pause(),t.prev()}),n(".am-next").click(function(n){n.preventDefault(),t.pause(),t.next()}),n(".am-tab").click(function(i){i.preventDefault();var e=n(this).index();t.pause(),t.slide(e)}),n(".am-pause").click(function(n){n.preventDefault(),t.pause()}),n(".am-play").click(function(n){n.preventDefault(),t.options.autoPlay?console.log("already playing"):t.play()})},this.next=function(){var n=this;if(!n.isAnimating){var t=n.current+1;n.animatingTo=t>n.numSlides-1?0:t,n.animate(),n.current=n.animatingTo,console.log("next")}},this.prev=function(){var n=this;if(!n.isAnimating){var t=n.current-1;n.animatingTo=0>t?n.numSlides-1:t,n.animate(),n.current=n.animatingTo,console.log("prev")}},this.slide=function(n){var t=this;n>=0&&n<=t.numSlides-1&&(t.isAnimating||t.current===n||(t.animatingTo=n,t.animate(),t.current=t.animatingTo,console.log("jumping to slide:"+t.animatingTo)))},this.pause=function(){var n=this;clearInterval(n.setInterval),n.options.autoPlay=!1,console.log("paused")},this.play=function(){var n=this;n.setInterval=setInterval(n.next.bind(n),n.options.slideDuration),n.options.autoPlay=!0,console.log("playing")},this.animate=function(){var t=this;t.options.cssTransitions&&t.transitionSupport?t.isAnimating||(console.log("current:"+t.current+"next:"+t.animatingTo),t.slides.eq(t.current).removeClass("am-current"),t.slides.eq(t.animatingTo).addClass("am-current"),n(".am-tab").eq(t.current).removeClass("am-tab-current"),n(".am-tab").eq(t.animatingTo).addClass("am-tab-current"),t.isAnimating=!0,n(t.slides.eq(t.current),t.slides.eq(t.animatingTo)).on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",function(){t.isAnimating=!1})):(t.slides.eq(t.animatingTo).fadeIn(t.options.animDuration),t.isAnimating=!0,setTimeout(function(){t.isAnimating=!1},t.options.animDuration))},this.init(a,s)},n.fn.slider=function(t){return this.each(function(){new n.slider(n(this),t)})},n.slider.defaultOptions={animDuration:1e3,autoPlay:!0,cssTransitions:!1,directionControls:!0,directionContolsText:{prev:"prev",next:"next"},navControls:!0,navControlsClass:".am-nav-controls",pauseOnHover:!1,slideContainer:".slides",slideElement:"li",slideDuration:5e3}}(jQuery),$(".am-slider").slider({autoPlay:!0,cssTransitions:!1,pauseOnHover:!1,directionControls:!0});