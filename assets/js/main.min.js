...
!function(n){"use strict";function i(i,t){if(t.directionControls===!0&&0===n(".am-direction-controls").length){var e='<ul class="am-direction-controls"><li class="am-prev"><a href="#">'+t.directionContolsText.prev+'</a></li><li class="am-next"><a href="#">'+t.directionContolsText.next+"</a></li></ul>";n(i).append(e)}}function t(i,t){if(".am-nav-controls"===t.navControlsClass&&0===n(".am-nav-controls").length){for(var e='<ul class="am-nav-controls">',a=n(t.slideContainer).find(t.slideElement).length,s=1;a+1>s;s++)e+='<li class="am-tab"><a href="#">'+s+"</a></li>";e+="</ul>",n(i).append(e)}else n(t.navControlsClass).children().addClass("am-tab")}function e(n){if("undefined"==typeof window.Modernizr){var i=document.body||document.documentElement,t=i.style,e="transition";if("string"==typeof t[e])return!0;e=e.charAt(0).toUpperCase()+e.substr(1);for(var a=0;a<n.length;a++)if("string"==typeof t[n[a]+e])return!0;return!1}return Modernizr.csstransitions?!0:void 0}n.amSlider=function(a,s){this.options={},this.el=n(a),this.el.data("slider",this),this.init=function(a,s){var o=this;console.log(o),o.options=n.extend({},n.amSlider.defaultOptions,s),s=o.options,o.slideContainer=o.el.children(s.slideContainer),o.slides=n(o.slideContainer).find(s.slideElement),o.numSlides=o.slides.length,o.isAnimating=!1,o.current=0,o.setInterval=null,o.transitionSupport=!1,o.domPrefixes="webkit Webkit Moz O ms Khtml".split(" "),e(o.domPrefixes)&&(o.transitionSupport=!0),s.directionControls&&i(a,s),s.navControls&&t(a,s),o.slides.eq(o.current).addClass("am-current"),n(".am-tab").eq(o.current).addClass("am-tab-current"),this.initEvents()},this.initEvents=function(){var i=this;i.slides.css("transition-duration",i.options.animDuration/1e3+"s"),i.options.autoPlay&&i.play(),i.options.pauseOnHover&&i.options.autoPlay&&i.el.hover(function(){i.pause()},function(){i.play()}),n(".am-prev").click(function(n){n.preventDefault(),i.pause(),i.prev()}),n(".am-next").click(function(n){n.preventDefault(),i.pause(),i.next()}),n(".am-tab").click(function(t){t.preventDefault();var e=n(this).index();i.pause(),i.slide(e)}),n(".am-pause").click(function(n){n.preventDefault(),i.pause()}),n(".am-play").click(function(n){n.preventDefault(),i.options.autoPlay?console.log("already playing"):i.play()})},this.next=function(){var n=this;if(!n.isAnimating){var i=n.current+1;n.animatingTo=i>n.numSlides-1?0:i,n.animate(),n.current=n.animatingTo,console.log("next")}},this.prev=function(){var n=this;if(!n.isAnimating){var i=n.current-1;n.animatingTo=0>i?n.numSlides-1:i,n.animate(),n.current=n.animatingTo,console.log("prev")}},this.slide=function(n){var i=this;n>=0&&n<=i.numSlides-1&&(i.isAnimating||i.current===n||(i.animatingTo=n,i.animate(),i.current=i.animatingTo,console.log("jumping to slide:"+i.animatingTo)))},this.pause=function(){var n=this;clearInterval(n.setInterval),n.options.autoPlay=!1,console.log("paused")},this.play=function(){var n=this;n.setInterval=setInterval(n.next.bind(n),n.options.slideDuration),n.options.autoPlay=!0,console.log("playing")},this.animate=function(){var i=this;i.options.cssTransitions&&i.transitionSupport?i.isAnimating||(console.log("current:"+i.current+"next:"+i.animatingTo),i.slides.eq(i.current).removeClass("am-current"),i.slides.eq(i.animatingTo).addClass("am-current"),n(".am-tab").eq(i.current).removeClass("am-tab-current"),n(".am-tab").eq(i.animatingTo).addClass("am-tab-current"),i.isAnimating=!0,n(i.slides.eq(i.current),i.slides.eq(i.animatingTo)).on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",function(){i.isAnimating=!1})):(i.slides.eq(i.animatingTo).fadeIn(i.options.animDuration),i.isAnimating=!0,setTimeout(function(){i.isAnimating=!1},i.options.animDuration))},this.init(a,s)},n.fn.amSlider=function(i){return this.each(function(){new n.amSlider(n(this),i)})},n.amSlider.defaultOptions={animDuration:1e3,autoPlay:!0,cssTransitions:!1,directionControls:!0,directionContolsText:{prev:"prev",next:"next"},navControls:!0,navControlsClass:".am-nav-controls",pauseOnHover:!1,slideContainer:".slides",slideElement:"li",slideDuration:5e3}}(jQuery);var something=$(".am-slider").amSlider({cssTransitions:!0});$(".clicknext").click(function(){something.data("amSlider").next()});